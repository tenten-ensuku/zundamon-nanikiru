...
function cleanDiscordExplanationArtifacts(value) {
...
function allowedStaticPath(rootDir, pathname) {
  ...
  if (["/index.html", "/admin.html", "/config.js", "/question-metadata.js", "/question-review.js", "/question-review.css", "/shared-data.js", "/answer-feedback.js", "/answer-feedback.css", "/desktop.css", "/public/shared-overrides.json"].includes(pathname)) return path.join(rootDir, pathname.slice(1));
