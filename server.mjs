...
function normalizeStructuredQuestion(value, id) {
  ...
  const videoSummary = typeof value.videoSummary === "string" ? value.videoSummary.trim() : "";
  if (videoSummary.length > MAX_EXPLANATION_LENGTH) return null;
  ...
  return {
    ...
    explanation, videoSummary, sourceUrl, sourceLabel: sourceUrl ? "元動画を開く" : "",
